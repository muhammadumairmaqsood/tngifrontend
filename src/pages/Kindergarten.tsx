...
const Kindergarten = () => {
    ...
    return (
        <Layout>
                ...
                <div className="relative section-inner text-white">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/90 mb-8">
                            Where curiosity blooms and lifelong learning begins through play, exploration, and wonder
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
                                <p>
                                    Each day in our Early Years Programme is thoughtfully designed to balance structured
            ...
            {/* IB Learner Profile for Young Children */}
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-3 gap-4 mt-8">
                                {['Caring', 'Curious', 'Open-minded', 'Communicators', 'Risk-takers', 'Reflective'].map((trait, index) => (
                                    <motion.div
                                        key={trait}
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        {[
                            ...
                            },
                            {
                                ...
                                description: 'Trained in early childhood development and IB pedagogy'
                            },
                            {
                                icon: Palette,
                            ...
                            },
                            {
                                ...
                                description: 'Personalized attention for each child\'s unique needs'
                            },
                            {
                                icon: Music,
                                title: 'Rich Co-Curricular',
                                description: 'Music, art, movement, and outdoor exploration'
                            },
                            {
                                icon: BookOpen,
                                title: 'Smooth Transition',
                                description: 'Seamless progression to our IB Primary Years Programme'
                            },
                        ].map((advantage, index) => (
                            <motion.div
                                key={advantage.title}
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            <p className="text-xl text-white/90 mb-8 leading-relaxed">
                                Join us for a campus tour and see how our Early Years Programme creates a foundation
                                for lifelong learning, confidence, and joy.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Button variant="hero" size="lg" asChild>
                                    <Link to="/programmes/primary-years">Explore Primary Years</Link>
                                </Button>
                            </div>
                        </motion.div>
                    </div>
